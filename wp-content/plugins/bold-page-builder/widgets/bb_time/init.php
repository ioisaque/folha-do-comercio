	...
	class BB_Time_Widget extends WP_Widget {
		...
		function __construct() {
			parent::__construct(
				...
				__( 'BB Time', 'bold-builder' ), // Name
				array( 'description' => __( 'Time widget.', 'bold-builder' ) ) // Args
			);
		}
		...
		public function widget( $args, $instance ) {
			...
			echo '<span id="' . $this->container_id . '" class="btIconWidget"><span class="btIconWidgetIcon">' . bt_bb_icon::get_html( $this->icon ) . '</span><span class="btIconWidgetContent"><span class="btIconWidgetTitle">' . $this->place_name . '</span><span class="btIconWidgetText"></span></span></span>';
		}
			...
			?>		
				...
				<p>
					...
					<select class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'time_notation' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'time_notation' ) ); ?>">
						...
						$tn = array( __( '24 hours', 'bold-builder' ) => '24', __( '12 hours', 'bold-builder' ) => '12' );
