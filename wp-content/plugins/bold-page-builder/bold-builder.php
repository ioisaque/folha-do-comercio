...
function bt_bb_enqueue() {
	...
	if ( $screen->base != 'post' && $screen->base != 'widgets' && $screen->base != 'customize' ) {
		return;
	}
...
class BT_BB_Element extends BT_BB_Basic_Element {
	...
	function add_params() {
		bt_bb_add_params( $this->shortcode, array(
			...
			array( 'param_name' => 'publish_datetime', 'type' => 'datetime-local', 'heading' => __( 'Publish date', 'bold-builder' ), 'description' => __( 'Please, fill both the date and time', 'bold-builder' ), 'group' => __( 'Custom', 'bold-builder' ), 'weight' => 998 ),
			array( 'param_name' => 'expiry_datetime', 'type' => 'datetime-local', 'heading' => __( 'Expiry date', 'bold-builder' ), 'description' => __( 'Please, fill both the date and time', 'bold-builder' ), 'group' => __( 'Custom', 'bold-builder' ), 'weight' => 999 ),
