...
class bt_bb_cost_calculator extends BT_BB_Element {
	...
	function handle_shortcode( $atts, $content ) {
		...
		$content .= '<div class="' . $this->shortcode . '_total"><div class="' . $this->shortcode . '_total_text">' . esc_html__( 'Total', 'bold-builder' ) . '</div><div class="' . $this->shortcode . '_total_amount">0.00</div></div>';
