...
class bt_bb_masonry_post_grid extends BT_BB_Element {
	...
	function handle_shortcode( $atts, $content ) {
		...
		$output .= '<div class="bt_bb_masonry_post_grid_content bt_bb_grid_hide" data-number="' . $number . '" data-category="' . $category . '" data-show="' . urlencode( serialize( $show ) ) . '" data-auto-loading="' . $auto_loading . '"><div class="bt_bb_grid_sizer"></div></div>';
