					...
					foreach ( $twitter_data as $data ) {
						...
						$output .= '<div class="bt_bb_twitter_item">';
							$output .= '<div class="content">';
								if( $show_avatar == 'yes' ) {
									$output .= '<a href="' . esc_url( $profile_link ) . '" target="_blank" title="@' . $user . '"><img src="https://twitter.com/' . $user . '/profile_image?size=bigger" class="bt_bb_twitter_avatar" alt="@' . $user . '" title="@' . $user . '"/></a>';
								}
								$output .= '<small class="bt_bb_twitter_username"><a href="' . esc_url( $link ) . '" target="_blank" title="@' . $user . '">@' . $user . ' - ' . $time . '</a></small>';
